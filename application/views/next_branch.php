<?=$Header;?>	
                    ...
                    <!-- Next and New example Buttons will appear once the Audio will finish -->
                        ...
                        <div class="intro-screen-01  col-md-8 col-sm-10 col-xs-10 col-md-offset-2 col-sm-offset-1 col-xs-offset-1" style="display:none;">
                            <a href="javascript:void(0)" class="next-button col-md-4 col-sm-4 col-xs-4 text-center col-md-offset-1 col-sm-offset-1 col-xs-offset-1">Start</a>
                             <a href="nextbranchinfo" class="blue-button more-info col-md-5 col-sm-5 col-xs-5 text-center col-md-offset-1 col-sm-offset-1 col-xs-offset-1">More Info</a>
                        </div>
	...
	<script type="text/javascript" src="resources/js/nextbranch.js"></script>
<?=$Footer;?>